...
.PHONY: api-build api-run api-test build clean clean-all clean-bin \
	clean-db client-build client-build-all client-build-windows client-run client-test help test
